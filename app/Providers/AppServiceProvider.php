                        ...
                        function ensureBadge(link){
                            ...
                            if(!badge){
                                ...
                                if(iconContainer){
                                    ...
                                    badge.className='action-board-badge absolute bottom-2 right-4 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-white bg-red-500 rounded-full shadow-lg z-10 bounce-bounce';
