                                                    ...
                                                    Forms\Components\TextInput::make('meeting_url')
                                                        ...
                                                        ->prefixAction(
                                                            Forms\Components\Actions\Action::make('regenerate_meet_link')
                                                                ...
                                                                ->modalHeading('Regenerate Google Meet Link')
                                                                ->modalDescription('Are you sure you want to regenerate the meeting link? The old link will be deleted.')
                                                                ...
                                                                ->action(function (Forms\Set $set, Forms\Get $get) {
                                                                    ...
                                                                    if (! $token) {
                                                                        Notification::make()
                                                                            ...
                                                                            ->body('Please connect your Google Calendar account to regenerate meeting links.')
                                                                            ->warning()
                                                                            ->send();
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        if ($result) {
                                                                            ...
                                                                            Notification::make()
                                                                                ->title('Google Meet link regenerated successfully!')
                                                                                ->body('Don\'t forget to save the meeting link.')
                                                                                ->warning()
                                                                                ->send();
                                                                        } else {
                                                                            Notification::make()
                                                                                ->title('Failed to regenerate Google Meet link')
                                                                        ...
                                                                        Notification::make()
                                                                            ->title('Error regenerating Google Meet link')
                                                        ...
                                                        ->suffixAction(
                                                            Forms\Components\Actions\Action::make('copy_meet_link')
                                                                ->label('Copy')
                                                                ...
                                                                ->action(function (Forms\Get $get) {
                                                                    ...
                                                                    $this->dispatch('copy-to-clipboard', text: $get('meeting_url'));
