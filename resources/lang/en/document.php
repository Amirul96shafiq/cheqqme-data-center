...
return [
    ...
    'actions' => [
        ...
        'make_draft_tooltip' => 'Change this document to Draft status (only you can see it)',
        'make_active_tooltip' => 'Change this document to Active status (all users can see it)',
