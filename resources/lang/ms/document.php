...
return [
    ...
    'actions' => [
        ...
        'make_draft_tooltip' => 'Tukar dokumen ini ke Draf (Hanya anda boleh melihatnya)',
        'make_active_tooltip' => 'Tukar dokumen ini ke Aktif (Semua pengguna boleh melihatnya)',
