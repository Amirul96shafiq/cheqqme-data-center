...
return [
    ...
    'actions' => [
        ...
        'make_draft_tooltip' => 'Tukar URL Penting ini ke Draf (Hanya anda boleh melihatnya)',
        'make_active_tooltip' => 'Tukar URL Penting ini ke Aktif (Semua pengguna boleh melihatnya)',
