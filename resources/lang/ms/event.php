...
return [
    ...
    'form' => [
        ...
        'location_method' => 'Kaedah Input Lokasi',
        'location_method_url' => 'Gunakan URL Kongsi Google Maps',
        'location_method_picker' => 'Gunakan Peta Interaktif',
        'maps_share_url' => 'URL Kongsi Google Maps',
        'maps_share_url_help' => 'Tampal URL kongsi Google Maps untuk mengisi butiran lokasi secara automatik',
        'location_picker_help' => 'Gunakan peta interaktif untuk mencari dan memilih lokasi anda',
        'location_title' => 'Tajuk Lokasi',
