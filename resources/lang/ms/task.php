...
return [
    'form' => [
        ...
        'client_helper' => 'Pilih pelanggan untuk mengurus sumber tugasan',
        'client_helper_issue_tracker' => 'Diisi secara automatik daripada projek yang dikaitkan (baca sahaja)',
        'project_helper_issue_tracker' => 'Dikaitkan dengan tugasan penjejak isu ini (baca sahaja, 1 projek sahaja)',
        'document_helper_issue_tracker' => 'Pilih dokumen daripada projek yang dikaitkan (boleh diedit)',
        'important_url_helper_issue_tracker' => 'Pilih URL penting daripada projek yang dikaitkan (boleh diedit)',
        'title' => 'Tajuk',
        'value' => 'Nilai',
        'comments' => 'Komen',
        ...
        'enable_attachments' => 'Lampiran',
        'enable_task_resources' => 'Sumber Tugasan',
