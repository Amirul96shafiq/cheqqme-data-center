            ...
            if (response.ok) {
                ...
                if (data.conversation && data.conversation.length > 0) {
                    ...
                    setTimeout(() => {
                        ...
                        // Add additional message about Commands action
                        setTimeout(() => {
                            addMessage(
                                'Or use the commands listed in the <span class="chatbot-help-command inline-flex items-center gap-1"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg></span> Commands action below!',
                                "assistant",
                                welcomeTs
                            );
                        }, 500); // Delay to show after help message
