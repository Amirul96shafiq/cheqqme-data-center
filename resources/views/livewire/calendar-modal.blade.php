                        ...
                        <div class="px-3 py-2 rounded-lg border-l-4 bg-gray-50 dark:bg-gray-800/50"
                            ...
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <template x-if="event.event_type === 'online' && event.meeting_url">
                                        <x-tooltip text="{{ __('calendar.tooltip.join') }}" position="left">
                                    ...
                                    <template x-if="event.event_type === 'offline' && (event.location_title || event.location_full_address || event.location_place_id)">
