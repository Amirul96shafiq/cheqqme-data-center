...
<div class="flex flex-col flex-1 h-full min-h-0 rounded-xl" 
            ...
            <div role="dialog" aria-modal="true" aria-labelledby="delete-comment-heading" class="comment-delete-modal fi-modal-window relative w-full max-w-sm md:max-w-md mx-auto cursor-default flex flex-col rounded-xl bg-white dark:bg-gray-900 shadow-xl ring-1 ring-gray-950/5 dark:ring-white/10 px-6 pt-8 pb-6 pointer-events-auto">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <div class="mt-6 flex w-full items-stretch gap-3">
                        ...
                        <button type="button" wire:click="performDelete" class="fi-btn flex-1 inline-flex items-center justify-center gap-1.5 rounded-lg px-5 h-10 text-sm font-medium tracking-tight bg-yellow-600 text-white hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500/40 focus:ring-offset-2 focus:ring-offset-white dark:bg-yellow-600 dark:hover:bg-yellow-500 dark:focus:ring-offset-gray-900">{{ __('comments.modal.delete.confirm') }}</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div role="dialog" aria-modal="true" aria-labelledby="delete-reply-heading" class="comment-delete-modal fi-modal-window relative w-full max-w-sm md:max-w-md mx-auto cursor-default flex flex-col rounded-xl bg-white dark:bg-gray-900 shadow-xl ring-1 ring-gray-950/5 dark:ring-white/10 px-6 pt-8 pb-6 pointer-events-auto">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <div class="mt-6 flex w-full items-stretch gap-3">
                        ...
                        <button type="button" wire:click="deleteReply" class="fi-btn flex-1 inline-flex items-center justify-center gap-1.5 rounded-lg px-5 h-10 text-sm font-medium tracking-tight bg-yellow-600 text-white hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500/40 focus:ring-offset-2 focus:ring-offset-white dark:bg-yellow-600 dark:hover:bg-yellow-500 dark:focus:ring-offset-gray-900">{{ __('comments.modal.delete.confirm') }}</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    @if($confirmingForceDeleteId)
        ...
        <div wire:ignore
            ...
            x-init="
                ...
                observer.observe(document.body, { childList: true, subtree: true });
            "
            x-on:keydown.escape.window="$wire.cancelForceDelete()"
            class="fixed inset-0 z-[9999] flex items-center justify-center"
        >
            <!-- Force delete comment modal backdrop -->
            <div class="comment-delete-modal-backdrop absolute inset-0 bg-gray-950/50 dark:bg-gray-950/75" wire:click="cancelForceDelete" aria-hidden="true"></div>
            <!-- Force delete comment modal -->
            <div role="dialog" aria-modal="true" aria-labelledby="force-delete-comment-heading" class="comment-delete-modal fi-modal-window relative w-full max-w-sm md:max-w-md mx-auto cursor-default flex flex-col rounded-xl bg-white dark:bg-gray-900 shadow-xl ring-1 ring-gray-950/5 dark:ring-white/10 px-6 pt-8 pb-6 pointer-events-auto">
                <!-- Force delete comment modal close button -->
                <button type="button" wire:click="cancelForceDelete" class="fi-modal-close-btn absolute end-4 top-4 inline-flex items-center justify-center rounded-md text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-900" aria-label="{{ __('comments.modal.force_delete.close') }}">
                    <svg class="w-6 h-6" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
                </button>
                <!-- Force delete comment modal content -->
                <div class="flex flex-col items-center text-center">
                    <div class="mb-5 flex items-center justify-center">
                    ...
                    <!-- Force delete comment modal heading -->
                    <h2 id="force-delete-comment-heading" class="fi-modal-heading text-base font-semibold text-gray-900 dark:text-gray-100">{{ __('comments.modal.force_delete.title') }}</h2>
                    <!-- Force delete comment modal description -->
                    <p class="fi-modal-description mt-2 text-sm leading-relaxed text-gray-600 dark:text-gray-400">{{ __('comments.modal.force_delete.description') }}</p>
                    <!-- Force delete comment modal actions -->
                    <div class="mt-6 flex w-full items-stretch gap-3">
                        <!-- Force delete comment modal cancel button -->
                        <button data-modal-initial type="button" wire:click="cancelForceDelete" class="fi-btn flex-1 inline-flex items-center justify-center gap-1.5 rounded-lg px-5 h-10 text-sm font-medium tracking-tight border border-gray-300 bg-white text-gray-800 hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:ring-offset-2 focus:ring-offset-white dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:border-gray-500 dark:focus:ring-primary-500/40 dark:focus:ring-offset-gray-900">{{ __('comments.modal.force_delete.cancel') }}</button>
                        <!-- Force delete comment modal confirm button -->
                        <button type="button" wire:click="forceDeleteComment({{ $confirmingForceDeleteId }})" class="fi-btn fi-color-danger flex-1 inline-flex items-center justify-center gap-1.5 rounded-lg px-5 h-10 text-sm font-medium tracking-tight bg-danger-600 text-white hover:bg-danger-500 focus:outline-none focus:ring-2 focus:ring-danger-500/40 focus:ring-offset-2 focus:ring-offset-white dark:bg-danger-600 dark:hover:bg-danger-500 dark:focus:ring-offset-gray-900">{{ __('comments.modal.force_delete.confirm') }}</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    @if($confirmingForceDeleteReplyId)
        <!-- Elevated z-index to ensure overlay sits above form action buttons -->
        <div wire:ignore
            x-data
            x-init="
                ...
                observer.observe(document.body, { childList: true, subtree: true });
            "
            x-on:keydown.escape.window="$wire.cancelForceDeleteReply()"
            class="fixed inset-0 z-[9999] flex items-center justify-center"
        >
            <!-- Force delete reply modal backdrop -->
            <div class="comment-delete-modal-backdrop absolute inset-0 bg-gray-950/50 dark:bg-gray-950/75" wire:click="cancelForceDeleteReply" aria-hidden="true"></div>
            <!-- Force delete reply modal -->
            <div role="dialog" aria-modal="true" aria-labelledby="force-delete-reply-heading" class="comment-delete-modal fi-modal-window relative w-full max-w-sm md:max-w-md mx-auto cursor-default flex flex-col rounded-xl bg-white dark:bg-gray-900 shadow-xl ring-1 ring-gray-950/5 dark:ring-white/10 px-6 pt-8 pb-6 pointer-events-auto">
                <!-- Force delete reply modal close button -->
                <button type="button" wire:click="cancelForceDeleteReply" class="fi-modal-close-btn absolute end-4 top-4 inline-flex items-center justify-center rounded-md text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-900" aria-label="{{ __('comments.modal.force_delete_reply.close') }}">
                    <svg class="w-6 h-6" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
                </button>
                <!-- Force delete reply modal content -->
                <div class="flex flex-col items-center text-center">
                    <div class="mb-5 flex items-center justify-center">
                        <div class="p-3 rounded-full bg-danger-100 text-danger-600 dark:bg-danger-500/20 dark:text-danger-400">
                            <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg>
                    ...
                    <!-- Force delete reply modal heading -->
                    <h2 id="force-delete-reply-heading" class="fi-modal-heading text-base font-semibold text-gray-900 dark:text-gray-100">{{ __('comments.modal.force_delete_reply.title') }}</h2>
                    <!-- Force delete reply modal description -->
                    <p class="fi-modal-description mt-2 text-sm leading-relaxed text-gray-600 dark:text-gray-400">{{ __('comments.modal.force_delete_reply.description') }}</p>
                    <!-- Force delete reply modal actions -->
                    <div class="mt-6 flex w-full items-stretch gap-3">
                        <!-- Force delete reply modal cancel button -->
                        <button data-modal-initial type="button" wire:click="cancelForceDeleteReply" class="fi-btn flex-1 inline-flex items-center justify-center gap-1.5 rounded-lg px-5 h-10 text-sm font-medium tracking-tight border border-gray-300 bg-white text-gray-800 hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:ring-offset-2 focus:ring-offset-white dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:border-gray-500 dark:focus:ring-primary-500/40 dark:focus:ring-offset-gray-900">{{ __('comments.modal.force_delete_reply.cancel') }}</button>
                        <!-- Force delete reply modal confirm button -->
                        <button type="button" wire:click="forceDeleteReply" class="fi-btn fi-color-danger flex-1 inline-flex items-center justify-center gap-1.5 rounded-lg px-5 h-10 text-sm font-medium tracking-tight bg-danger-600 text-white hover:bg-danger-500 focus:outline-none focus:ring-2 focus:ring-danger-500/40 focus:ring-offset-2 focus:ring-offset-white dark:bg-danger-600 dark:hover:bg-danger-500 dark:focus:ring-offset-gray-900">{{ __('comments.modal.force_delete_reply.confirm') }}</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    @if(!$confirmingDeleteId && !$confirmingDeleteReplyId && !$confirmingForceDeleteId && !$confirmingForceDeleteReplyId)
        <script>
            // Ensure the helper class is cleared when modal not present
