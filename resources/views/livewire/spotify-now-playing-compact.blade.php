        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-2 border border-gray-200 dark:border-gray-700">
            ...
            <div class="flex items-center justify-between mb-1.5">
                <div class="flex items-center gap-1">
                    ...
                    @if($track['is_playing'])
                        <span class="text-[10px] font-normal text-green-600 dark:text-green-400">Now Playing</span>
                    @else
                        <span class="text-[10px] font-normal text-gray-500 dark:text-gray-400">Paused</span>
                    @endif  
                </div>
