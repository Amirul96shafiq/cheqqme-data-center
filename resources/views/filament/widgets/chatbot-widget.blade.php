            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-4" id="chat-messages">
                <div class="flex justify-start">
                    <div class="bg-gray-100 dark:bg-gray-700 rounded-lg px-3 py-2 shadow-sm">
                        <p class="text-sm text-gray-800 dark:text-gray-200">Hello! I'm CheQQme, your AI assistant for the CheQQme Data Center. I can help you navigate the platform, find resources, answer questions about projects and tasks, and much more. How can I help you today?</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ now()->format('H:i') }}</p>
                    </div>
                </div>
            </div>
        ...
        function clearConversation() {
            ...
            chatMessages.innerHTML = `
                <div class="flex justify-start">
                    <div class="bg-gray-100 dark:bg-gray-700 rounded-lg px-3 py-2 shadow-sm">
                        <p class="text-sm text-gray-800 dark:text-gray-200">Hello! I'm CheQQme, your AI assistant for the CheQQme Data Center. I can help you navigate the platform, find resources, answer questions about projects and tasks, and much more. How can I help you today?</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">${new Date().toLocaleTimeString('en-US', {hour: '2-digit', minute:'2-digit'})}</p>
                    </div>
                </div>
            `;
