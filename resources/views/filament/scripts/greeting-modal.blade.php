        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow-2xl max-w-5xl w-full max-h-[90vh] transform transition-all duration-300 scale-95 opacity-0 border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col">
            <div class="flex flex-col lg:flex-row flex-1 overflow-y-auto">
                ...
                <div class="p-6 flex flex-col justify-end bg-cover bg-center bg-no-repeat w-full lg:w-3/5 order-1 lg:order-2 relative"
                    ...
                    <div id="quick-actions-container" class="space-y-3 mb-6 max-h-80 overflow-y-auto scrollbar-none">
                        ...
                        <button onclick="toggleProfileVideo()" class="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 rounded-lg transition-colors duration-200 group border border-gray-200 dark:border-gray-600 w-full text-left">
                            ...
                            <div class="flex-shrink-0 flex items-center" x-data="{ isVideoActive: false }" x-init="isVideoActive = !document.getElementById('profile-video')?.classList.contains('hidden')">
                                ...
                                <svg class="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-all duration-200" x-bind:class="{ 'rotate-90': isVideoActive }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Chatbot History Quick Action -->
                        <button onclick="toggleChatbotHistoryVideo()" class="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 rounded-lg transition-colors duration-200 group border border-gray-200 dark:border-gray-600 w-full text-left">
                            <div class="w-10 h-10 bg-primary-50 dark:bg-primary-900/20 rounded-lg flex items-center justify-center group-hover:bg-primary-100 dark:group-hover:bg-primary-900/40 transition-colors flex-shrink-0">
                                @svg('heroicon-o-chat-bubble-left-right', 'w-5 h-5 text-primary-600 dark:text-primary-400')
                            </div>
                            <div class="flex-1 min-w-0">
                                <h5 class="text-sm font-semibold text-gray-900 dark:text-white mb-1 group-hover:text-primary-700 dark:group-hover:text-primary-300 transition-colors">
                                    {{ __('greetingmodal.action-7-title') }}
                                </h5>
                                <p class="text-xs text-gray-500 dark:text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors">
                                    {{ __('greetingmodal.action-7-description') }}
                                </p>
                            </div>
                            <div class="flex-shrink-0 flex items-center" x-data="{ isVideoActive: false }" x-init="isVideoActive = !document.getElementById('chatbot-history-video')?.classList.contains('hidden')">
                                <span onclick="event.stopPropagation(); navigateToChatbotHistory()" class="text-sm text-gray-400 dark:text-gray-500 hover:text-primary-600 dark:hover:text-primary-400 transition-colors mr-2 cursor-pointer">{{ __('greetings.view_action') }}</span>
                                <svg class="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-all duration-200" x-bind:class="{ 'rotate-90': isVideoActive }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                            </div>
                        ...
                        <!-- Events Quick Action -->
                        <button onclick="toggleEventsVideo()" class="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 rounded-lg transition-colors duration-200 group border border-gray-200 dark:border-gray-600 w-full text-left">
                            <div class="w-10 h-10 bg-primary-50 dark:bg-primary-900/20 rounded-lg flex items-center justify-center group-hover:bg-primary-100 dark:group-hover:bg-primary-900/40 transition-colors flex-shrink-0">
                                @svg('heroicon-o-calendar', 'w-5 h-5 text-primary-600 dark:text-primary-400')
                            </div>
                            <div class="flex-1 min-w-0">
                                <h5 class="text-sm font-semibold text-gray-900 dark:text-white mb-1 group-hover:text-primary-700 dark:group-hover:text-primary-300 transition-colors">
                                    {{ __('greetingmodal.action-8-title') }}
                                </h5>
                                <p class="text-xs text-gray-500 dark:text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors">
                                    {{ __('greetingmodal.action-8-description') }}
                                </p>
                            </div>
                            <div class="flex-shrink-0 flex items-center" x-data="{ isVideoActive: false }" x-init="isVideoActive = !document.getElementById('events-video')?.classList.contains('hidden')">
                                <span onclick="event.stopPropagation(); navigateToEvents()" class="text-sm text-gray-400 dark:text-gray-500 hover:text-primary-600 dark:hover:text-primary-400 transition-colors mr-2 cursor-pointer">{{ __('greetings.view_action') }}</span>
                                <svg class="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-all duration-200" x-bind:class="{ 'rotate-90': isVideoActive }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                            </div>
                    ...
                    <!-- Chatbot History Video Container -->
                    <div id="chatbot-history-video" class="hidden mt-[-20px] mb-6 opacity-0 transform scale-95 transition-all duration-300 ease-in-out">
                        <div class="bg-gray-50/10 dark:bg-gray-700/10 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                            <div class="flex items-center justify-between mb-3">
                                <h6 class="text-sm font-semibold text-gray-900 dark:text-white">
                                    {{ __('greetingmodal.action-7-title') }} Tutorial
                                </h6>
                                <x-close-button
                                    onclick="toggleChatbotHistoryVideo()"
                                    aria-label="Close video"
                                />
                            </div>
                            <div class="relative group">
                                <video
                                    id="chatbot-history-tutorial-video"
                                    class="w-full rounded-lg shadow-sm cursor-pointer"
                                    preload="none"
                                    loop
                                    muted
                    ...
                    <div id="events-video" class="hidden mt-[-20px] mb-6 opacity-0 transform scale-95 transition-all duration-300 ease-in-out">
                        <div class="bg-gray-50/10 dark:bg-gray-700/10 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                            <div class="flex items-center justify-between mb-3">
                                <h6 class="text-sm font-semibold text-gray-900 dark:text-white">
                                    {{ __('greetingmodal.action-8-title') }} Tutorial
                                </h6>
                                <x-close-button
                                    onclick="toggleEventsVideo()"
                                    aria-label="Close video"
                                />
                            </div>
                            <div class="relative group">
                                <video
                                    id="events-tutorial-video"
                                    class="w-full rounded-lg shadow-sm cursor-pointer"
                                    preload="none"
                                    loop
                                    muted
