...
<aside
    ...
    {{
        $attributes->class([
            'fi-sidebar fixed inset-y-0 start-0 z-30 border-r border-gray-200 dark:border-gray-800 flex flex-col h-screen content-start bg-white transition-all dark:bg-gray-900 lg:z-0 lg:bg-white lg:shadow-none lg:ring-0 lg:transition-none dark:lg:bg-gray-900',
...
>
    ...
    <nav
        ...
        style="scrollbar-gutter: stable; margin-right: -7px;"
    >
