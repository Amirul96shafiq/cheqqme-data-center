...
>
    <div class="ff-card__content">
        ...
        @php
            ...
            $filtered = $attributes->except(['assigned_to_username_self', 'assigned_to_username', 'due_date_red', 'due_date_yellow', 'due_date_gray', 'due_date_green', 'featured_image']);
        @endphp
        @if($assignedBadge || $dueDateBadge)
            <div class="flex justify-between items-center mt-5 mb-1 gap-2">
                <div>
                    @if($assignedBadge)
