...
<div class="ff-empty-column" style="transition: opacity 0.2s ease-out, transform 0.2s ease-out;">
    ...
    <p class="ff-empty-column__text">
        {{ __('flowforge.empty_column', ['cardLabel' => strtolower($pluralCardLabel)]) }}
    </p>
</div>
