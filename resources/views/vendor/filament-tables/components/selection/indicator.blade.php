...
<div
    ...
    {{
        $attributes
            ...
            ->class([
                'fi-ta-selection-indicator flex flex-col justify-between gap-y-1 bg-gray-50/65 px-3 py-2 dark:bg-white/5 sm:flex-row sm:items-center sm:px-6 sm:py-1.5 backdrop-blur-lg z-10',
            ])
    }}
>
